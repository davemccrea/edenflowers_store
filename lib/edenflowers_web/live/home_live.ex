    ...
    <Layouts.app current_user={@current_user} order={@order} flash={@flash} current_path={@current_path}>
      ...
      >
        <div class="grid grid-cols-1 items-start gap-12 md:grid-cols-2 md:gap-16 lg:gap-24">
          ...
          <%!--
            Map of Vaasa region. Generated by `mix eden.fetch_map` which calls
            the Mapbox Static Images API. Style JSON lives at
            priv/mapbox/eden-vaasa-style.json — to retune (colors, opacity,
            water rendering): edit the JSON, PATCH the Mapbox style, refetch.
            See lib/mix/tasks/eden.fetch_map.ex for composition spec.

            The PNG is not in git — rsync the output of `mix eden.fetch_map`
            (priv/static/images/home-vaasa-map.png) to the server's Imgproxy
            local mount so this Imgproxy URL resolves.
          --%>
          <img
            src={
