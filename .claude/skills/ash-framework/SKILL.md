...
```sh
mix usage_rules.search_docs "search term" -p ash -p ash_archival -p ash_authentication -p ash_authentication_phoenix -p ash_phoenix -p ash_postgres -p ash_state_machine -p ash_translation
```
