...
for name <- ["David", "Jennie", "Febe", "Rolf"] do
  Driver.create!(%{name: name}, authorize?: false)
end
...
orders = [
  %{
    ...
    geocoded_address: "Gerbyntie 16, 65230 Vaasa",
  ...
  %{
    ...
    geocoded_address: "Sundomintie 130, 65410 Vaasa",
  ...
  %{
    ...
    geocoded_address: "Vanhan Vaasan katu 20, 65370 Vaasa",
  ...
  %{
    ...
    geocoded_address: "Rantamaantie 31, 65350 Vaasa",
  ...
  %{
    ...
    geocoded_address: "Hovioikeudenpuistikko 15, 65100 Vaasa",
  ...
  %{
    ...
    geocoded_address: "Palosaarentie 24, 65200 Vaasa",
  ...
  %{
    ...
    geocoded_address: "Kirkkopuistikko 24, 65100 Vaasa",
  ...
  %{
    customer_name: "Mikko Lehtinen",
    customer_email: "mikko.lehtinen@example.fi",
    fulfillment_option: home_delivery,
    fulfillment_date: today,
    recipient_name: "Mikko Lehtinen",
    recipient_phone_number: "+358 40 614 7281",
    delivery_address: "Koulukatu 15, 65100 Vaasa",
    geocoded_address: "Koulukatu 15, 65100 Vaasa",
    position: "63.09732,21.60581",
    here_id: "here:af:streetsection:t-Px7pzKKaKXHMuUtEW22D:CgcIBCCNnIF-EAEaAjE1",
    distance: 4094,
    gift: false,
    locale: "fi",
    delivery_instructions: "Soita ovikelloa. Jätä kukat eteiseen.",
    items: [{"Bouquet 4", :medium, 1}]
  },
  %{
    customer_name: "Karin Backman",
    customer_email: "karin.backman@example.fi",
    fulfillment_option: home_delivery,
    fulfillment_date: today,
    recipient_name: "Karin Backman",
    recipient_phone_number: "+358 50 741 3062",
    delivery_address: "Fredsgatan 20, 65100 Vasa",
    geocoded_address: "Fredsgatan 20, 65100 Vasa",
    position: "63.09368,21.61908",
    here_id: "here:af:streetsection:ktf50kdgitIASVtfd6XrRB:CgcIBCCTqIF-EAEaAjIw",
    distance: 4248,
    gift: false,
    locale: "sv-FI",
    delivery_instructions: "Ring på porttelefonen. Lägenhet 12.",
    items: [{"Plant 3", :medium, 1}, {"Bouquet 2", :small, 1}]
  },
  %{
    customer_name: "Noora Koskinen",
    customer_email: "noora.koskinen@example.fi",
    fulfillment_option: home_delivery,
    fulfillment_date: today,
    recipient_name: "Noora Koskinen",
    recipient_phone_number: "+358 44 185 6390",
    delivery_address: "Wolffintie 30, 65200 Vaasa",
    geocoded_address: "Wolffintie 30, 65200 Vaasa",
    position: "63.10663,21.59164",
    here_id: "here:af:streetsection:ALUmkItG7ckcjrLwqzxOIC:CggIBCD3jNeOAxABGgIzMA",
    distance: 2610,
    gift: true,
    locale: "fi",
    delivery_instructions: "Soita vastaanottajalle, kun olet pihalla.",
    card_message: "Paljon onnea uuteen kotiin!",
    card: {"Card 4", :medium},
    items: [{"Bouquet 1", :large, 1}]
  },
  %{
    customer_name: "Lars Eriksson",
    customer_email: "lars.eriksson@example.fi",
    fulfillment_option: home_delivery,
    fulfillment_date: today,
    recipient_name: "Lars Eriksson",
    recipient_phone_number: "+358 45 620 1744",
    delivery_address: "Smedsbyvägen 4, 65100 Vasa",
    geocoded_address: "Smedsbyvägen 4, 65100 Vasa",
    position: "63.09805,21.62671",
    here_id: "here:af:streetsection:WPRfHKoWxwOzelr-NLpM1C:CgcIBCCU6IB-EAEaATQ",
    distance: 4023,
    gift: false,
    locale: "sv-FI",
    delivery_instructions: "Använd ingången från gården.",
    items: [{"Bouquet 6", :small, 1}, {"Plant 4", :small, 1}]
  },
  %{
    customer_name: "Oliver Wilson",
    customer_email: "oliver.wilson@example.fi",
    fulfillment_option: home_delivery,
    fulfillment_date: today,
    recipient_name: "Oliver Wilson",
    recipient_phone_number: "+358 50 392 8475",
    delivery_address: "Asemakatu 12, 65100 Vaasa",
    geocoded_address: "Asemakatu 12, 65100 Vaasa",
    position: "63.09529,21.62188",
    here_id: "here:af:streetsection:PXptYIVFITR4gATzMUPLUB:CgcIBCDu5oB-EAEaAjEy",
    distance: 4364,
    gift: true,
    locale: "en-GB",
    delivery_instructions: "Call when you arrive. The entrance is beside the café.",
    card_message: "Wishing you a speedy recovery.",
    card: {"Card 2", :medium},
    items: [{"Bouquet 3", :large, 1}]
  },
  %{
    customer_name: "Sari Kallio",
    customer_email: "sari.kallio@example.fi",
    fulfillment_option: home_delivery,
    fulfillment_date: today,
    recipient_name: "Sari Kallio",
    recipient_phone_number: "+358 41 806 2359",
    delivery_address: "Pitkäkatu 28, 65100 Vaasa",
    geocoded_address: "Pitkäkatu 28, 65100 Vaasa",
    position: "63.09846,21.61663",
    here_id: "here:af:streetsection:T3D0HufOMGD9srP1.v6C6A:EAIaAjI4",
    distance: 3565,
    gift: false,
    locale: "fi",
    delivery_instructions: "Ovikoodi 6028. Hissi on sisäpihan puolella.",
    items: [{"Plant 1", :large, 1}]
  },
  %{
    customer_name: "Maria Söderholm",
    customer_email: "maria.soderholm@example.fi",
    fulfillment_option: home_delivery,
    fulfillment_date: today,
    recipient_name: "Maria Söderholm",
    recipient_phone_number: "+358 44 973 5216",
    delivery_address: "Metviksgatan 3, 65200 Vasa",
    geocoded_address: "Metviksgatan 3, 65200 Vasa",
    position: "63.10632,21.60172",
    here_id: "here:af:streetsection:zsCcuinmQ564iN.-RvLEBA:CgcIBCCh-P99EAEaATM",
    distance: 2516,
    gift: true,
    locale: "sv-FI",
    delivery_instructions: "Lämna buketten vid dörren om ingen svarar.",
    card_message: "Tack för hjälpen!",
    card: {"Card 3", :medium},
    items: [{"Bouquet 5", :medium, 1}]
  },
  %{
    customer_name: "Antti Rantanen",
    customer_email: "antti.rantanen@example.fi",
    fulfillment_option: home_delivery,
    fulfillment_date: today,
    recipient_name: "Antti Rantanen",
    recipient_phone_number: "+358 40 258 9147",
    delivery_address: "Hietalahdenkatu 8, 65100 Vaasa",
    geocoded_address: "Hietalahdenkatu 8, 65100 Vaasa",
    position: "63.08659,21.62011",
    here_id: "here:af:streetsection:52v7DUdlJ0qKEf2EFhoBNB:CgcIBCDvyYF-EAEaATg",
    distance: 5457,
    gift: false,
    locale: "fi",
    delivery_instructions: "Käytä B-rappua. Vastaanottaja on kolmannessa kerroksessa.",
    items: [{"Bouquet 2", :large, 1}, {"Plant 2", :small, 1}]
  },
  %{
    customer_name: "Elin Berg",
    customer_email: "elin.berg@example.fi",
    fulfillment_option: home_delivery,
    fulfillment_date: today,
    recipient_name: "Elin Berg",
    recipient_phone_number: "+358 50 687 4320",
    delivery_address: "Storviksvägen 8, 65230 Vasa",
    geocoded_address: "Storviksvägen 8, 65230 Vasa",
    position: "63.12525,21.60171",
    here_id: "here:af:streetsection:jU0TJjyzm25DUrwdnjTQUC:CgcIBCDszfx9EAEaATg",
    distance: 412,
    gift: false,
    locale: "sv-FI",
    delivery_instructions: "Det vita huset närmast korsningen.",
    items: [{"Bouquet 4", :small, 2}]
  },
  %{
    customer_name: "James Carter",
    customer_email: "james.carter@example.fi",
    fulfillment_option: home_delivery,
    fulfillment_date: today,
    recipient_name: "James Carter",
    recipient_phone_number: "+358 45 319 7608",
    delivery_address: "Runsorintie 1, 65380 Vaasa",
    geocoded_address: "Runsorintie 1, 65380 Vaasa",
    position: "63.06089,21.73052",
    here_id: "here:af:streetsection:NW0Jp41kvl88YoU1.zpb4A:CgcIBCCW54B-EAEaATE",
    distance: 12_297,
    gift: true,
    locale: "en-GB",
    delivery_instructions: "Use the visitor entrance and ask for reception.",
    card_message: "Congratulations from the whole team.",
    card: {"Card 1", :medium},
    items: [{"Bouquet 6", :large, 1}, {"Plant 3", :small, 1}]
  }
]
