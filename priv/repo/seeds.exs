...
orders = [
  ...
  # Extra today home-delivery orders spread across Vaasa, so the delivery
  # dispatch page has a meaningful set to optimize across one or more drivers.
  %{
    customer_name: "Petra Aaltonen",
    customer_email: "petra.aaltonen@example.fi",
    fulfillment_option: home_delivery,
    fulfillment_date: today,
    recipient_name: "Petra Aaltonen",
    recipient_phone_number: "+358 40 222 3344",
    delivery_address: "Palosaarentie 30, 65200 Vaasa",
    geocoded_address: "Brändövägen 30, 65200 Vasa",
    position: "63.10750,21.59500",
    distance: 2600,
    gift: false,
    items: [{"Bouquet 2", :medium, 1}]
  },
  %{
    customer_name: "Markus Heikkilä",
    customer_email: "markus.heikkila@example.fi",
    fulfillment_option: home_delivery,
    fulfillment_date: today,
    recipient_name: "Markus Heikkilä",
    recipient_phone_number: "+358 50 333 7788",
    delivery_address: "Vöyrinkatu 12, 65100 Vaasa",
    geocoded_address: "Vörågatan 12, 65100 Vasa",
    position: "63.10100,21.61800",
    distance: 3200,
    gift: false,
    locale: "fi",
    items: [{"Bouquet 4", :small, 1}, {"Plant 1", :small, 1}]
  },
  %{
    customer_name: "Saara Niemi",
    customer_email: "saara.niemi@example.fi",
    fulfillment_option: home_delivery,
    fulfillment_date: today,
    recipient_name: "Tuula Niemi",
    recipient_phone_number: "+358 44 901 2233",
    delivery_address: "Ristinummentie 5, 65300 Vaasa",
    geocoded_address: "Korsnäståget 5, 65300 Vasa",
    position: "63.09250,21.65200",
    distance: 5400,
    gift: true,
    card_message: "Tankar med dig.",
    card: {"Card 3", :medium},
    items: [{"Bouquet 5", :large, 1}]
  },
  %{
    customer_name: "Ville Laaksonen",
    customer_email: "ville.laaksonen@example.fi",
    fulfillment_option: home_delivery,
    fulfillment_date: today,
    recipient_name: "Ville Laaksonen",
    recipient_phone_number: "+358 41 660 1122",
    delivery_address: "Huutoniementie 8, 65320 Vaasa",
    geocoded_address: "Roparnäsvägen 8, 65320 Vasa",
    position: "63.08400,21.64500",
    distance: 6100,
    gift: false,
    items: [{"Plant 2", :medium, 2}]
  },
  %{
    customer_name: "Noora Salminen",
    customer_email: "noora.salminen@example.fi",
    fulfillment_option: home_delivery,
    fulfillment_date: today,
    recipient_name: "Noora Salminen",
    recipient_phone_number: "+358 45 778 9900",
    delivery_address: "Suvilahdentie 20, 65410 Vaasa",
    geocoded_address: "Sundomvägen 20, 65410 Vasa",
    position: "63.07900,21.63000",
    distance: 6300,
    gift: false,
    items: [{"Bouquet 6", :medium, 1}, {"Plant 3", :small, 1}]
  },
  %{
    customer_name: "Antti Rantala",
    customer_email: "antti.rantala@example.fi",
    fulfillment_option: home_delivery,
    fulfillment_date: today,
    recipient_name: "Antti Rantala",
    recipient_phone_number: "+358 40 119 8877",
    delivery_address: "Kappelinmäentie 4, 65380 Vaasa",
    geocoded_address: "Kapellbacksvägen 4, 65380 Vasa",
    position: "63.07200,21.59800",
    distance: 7000,
    gift: false,
    items: [{"Bouquet 1", :small, 1}]
  },
  %{
