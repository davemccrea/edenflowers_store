defmodule Edenflowers.Store.FulfillmentOptionTest do
  ...
  describe "Fulfillment Option Resource" do
    ...
    test "fails to create fulfillment option of type :dynamic if missing fields" do
      assert {:error, result} =
               FulfillmentOption
               |> Ash.Changeset.for_create(:create, %{name: "Home delivery", type: :dynamic})
               |> Ash.create()
    ...
    test "creates fulfillment option of type :fixed" do
      tax_rate = fixture(:tax_rate)
